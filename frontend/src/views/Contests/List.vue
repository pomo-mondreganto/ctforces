...
import OpenOrRegister from '@/components/Contests/OpenOrRegisterButton';
import Register from '@/components/Contests/RegisterButton';
import Open from '@/components/Contests/OpenButton';
